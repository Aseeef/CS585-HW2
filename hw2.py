...
def main():
    ...
    while True:
        ...
        fingers0 = hull_finger_counter(frame)
        # fingers1 = update_finger_count(contour)
        # print(f'Fingers: {fingers1}')

        # print(f'Hull:{fingers0}, Munirian:{finger1}')

        cv.putText(original, f'Fingers: {fingers0}', (10, 30), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv.LINE_AA)
